...
def load_data(file_path, nb_instances):
...
def main():
    ...
    tokens, postags, lemmas = load_data(file_path="../data/uniform/annotated/crm-adelheid/train/crm-adelheid_train.3col",
    ...
    postags = [pos for pos in postags if postag not in ("$", "@")]
